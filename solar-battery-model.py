...
P_0 = math.ceil((E[0][0] / L[0]) / (P * H[0] *24) * (0.35+(Pb*DoD)))
P_1 = math.ceil((E[0][1] / L[1]) / (P * H[1] *24) * (0.35+(Pb*DoD)))
P_2 = math.ceil((E[0][2] / L[2]) / (P * H[2] *24) * (0.35+(Pb*DoD)))
P_3 = math.ceil((E[0][3] / L[3]) / (P * H[3] *24) * (0.35+(Pb*DoD)))
Pn = max(P_0, P_1, P_2, P_3)

#find the Pn value if there was was no battery used
P_0_1 = math.ceil((E[0][0] / L[0]) / (P * H[0] *24) * (0.35))
P_1_1 = math.ceil((E[0][1] / L[1]) / (P * H[1] *24) * (0.35))
P_2_1 = math.ceil((E[0][2] / L[2]) / (P * H[2] *24) * (0.35))
P_3_1 = math.ceil((E[0][3] / L[3]) / (P * H[3] *24) * (0.35))

Pn_1 = max(P_0_1,P_1_1,P_2_1, P_3_1)
