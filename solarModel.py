...
# initializing
#model = Model()
model = LpProblem('Solar Model', LpMinimize)
...
model += (E[0][0]*0.35 - ((y * P * H[0] * 24 * L[0]))) >= 0, 'SD0'
model += (E[0][1]*0.35 - ((y * P * H[1] * 24 * L[1]))) >= 0, 'SD1'
model += (E[0][2]*0.35 - ((y * P * H[2] * 24 * L[2]))) >= 0, 'SD2'
model += (E[0][3]*0.35 - ((y * P * H[3] * 24 * L[3]))) >= 0, 'SD3'
